...
**📊 전체 데이터셋 (17.3MB)**
- [구글 드라이브 링크](https://drive.google.com/drive/folders/13IFaVh0aGyEBBYpc0j-Wb1als8jAJEn4).
- 파일명: `CSV-20260125T011313Z-1-001.zip`
- 또는 `data/` 폴더의 README 참조

**🤖 학습된 모델 파일 (13.7MB)**
- [구글 드라이브 링크](https://drive.google.com/drive/folders/1Bh5C93lrfTVpR_sExLlwCiKBcwT6zLwb).
- 필요 파일:
